        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2" style={{ fontFamily: 'Albert Sans, sans-serif' }}>
                {navLinks.map((link) => (
                  <li key={link.href}>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400" style={{ fontFamily: 'Albert Sans, sans-serif' }}>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400" style={{ fontFamily: 'Albert Sans, sans-serif' }}>

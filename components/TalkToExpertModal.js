            ...
            {submitStatus === 'success' ? (
              ...
              >
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-orange-500 text-white font-semibold text-sm rounded-xl hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-200"
              ...
              <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
                ...
                <div className="pt-2 pb-1">
                  <motion.button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 px-6 py-3.5 bg-orange-500 text-white font-semibold text-sm rounded-xl shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/30 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-200"
                    style={{ fontFamily: 'Bricolage Grotesque, sans-serif' }}

...
const heroSlides = [
  {
    ...
    title: 'Ghanas\nEvent',
    description: 'Ghana\'s event discovery and ticketing platform — Mobile Money payments, QR tickets, and listings across all 16 regions.',
    caseStudyLink: '/portfolio/ghanas-event',
  ...
  },
  {
    ...
    title: 'ACT Campus\nCare 2.0',
    description: 'A culturally grounded VR wellness platform helping HBCU students regulate stress, build resilience, and restore wellbeing.',
    caseStudyLink: '/portfolio/act-campus-care',
    caseStudyLabel: 'VIEW PROJECT',
    ctaLink: '/contact',
    ctaLabel: 'START YOUR PROJECT',
  ...
  },
  {
    tag: 'NEWS & MEDIA, CMS',
    title: 'Ghanas Event\nBlog',
    description: 'An editorial platform for organiser guides, city event roundups, and stories from Ghana\'s growing live-events industry.',
    caseStudyLink: '/portfolio/ghanas-event-blog',
    caseStudyLabel: 'VIEW PROJECT',
    ctaLink: '/contact',
    ctaLabel: 'START YOUR PROJECT',

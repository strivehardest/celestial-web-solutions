...
const Navbar = () => {
  ...
  // ✅ NEW: Premium Schedule a Call Button — Desktop
  const ScheduleButton = () => (
    ...
    >
      ...
      {/* Text */}
      <span className="relative z-10 text-white tracking-wide">Schedule a Call</span>
  ...
  // ✅ NEW: Premium Schedule a Call Button — Mobile
  const ScheduleButtonMobile = () => (
    ...
    >
      ...
      <span className="relative z-10 text-white text-base tracking-wide">Schedule a Call</span>

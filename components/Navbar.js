...
const Navbar = () => {
  ...
  // Replace search emoji with Lucide icon
  const SearchButton = () => (
    <motion.button
      className="hidden md:flex items-center justify-center w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300"
  ...
  // Update mobile menu dark mode toggle
  const MobileActionButtons = () => (
    <div className="flex items-center space-x-3">
      <ThemeToggle darkMode={darkMode} toggleDarkMode={toggleDarkMode} isMobile={true} />
      <motion.button
        className="flex items-center justify-center w-12 h-12 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300"
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        onClick={() => {
        ...
        <div className="flex justify-between items-center h-18 md:h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <motion.a
              ...
              className="hidden md:flex items-center space-x-2 bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-orange-500/30 transition-all duration-300 relative overflow-hidden group"
              style={{ fontFamily: 'Quicksand, sans-serif' }}
              ...
              <div className="p-6 space-y-2">
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                  ...
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-xl font-semibold shadow-lg"
                    style={{ fontFamily: 'Quicksand, sans-serif' }}
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >

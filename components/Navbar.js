...
const Navbar = () => {
  ...
  const Logo = () => {
    ...
    const logoImagePath = "/logo.png"; // 👈 Change this to your logo path
    const useImageLogo = true; // 👈 Set to true to use image logo, false for text logo
    
    // Optional: Configure logo size
    const logoSize = "w-20 h-20"; // You can change this to w-8 h-8, w-16 h-16, etc.
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-18 md:h-20">
            ...
            <div className="flex items-center space-x-3">
              ...
              <motion.a
                href="https://wa.me/233530505031?text=Hi%20Waliu,%20I%27m%20interested%20in%20your%20web%20development%20services."
                target="_blank"

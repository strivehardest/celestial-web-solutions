...
const projects = [
  ...
  },
  {
    ...
    client: "Ghanas Event",
    clientCountry: "Ghana",
    description: "Ghanas Event is an event discovery and ticketing platform built for Ghana. Attendees can find concerts, festivals, conferences, church gatherings, and campus events across all 16 regions, while organisers can list events, accept Mobile Money and card payments, and issue secure QR tickets.",
    ...
    techLogos: [
      ...
      { name: "Tailwind CSS", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" },
      { name: "Paystack",     logo: "https://upload.wikimedia.org/wikipedia/commons/f/f9/Paystack_Logo.svg" },
    ],
    startDate: "2026-06-04",
    completionDate: "2026-08-26",
    duration: " 2.5 months",
    features: [
      "Event Discovery Across All 16 Regions",
      "Event Search and Category Filters",
      "Organiser Event Management",
      "Mobile Money and Card Payments",
      "Secure QR Code Tickets",
      "Hotels and Tourist Destination Discovery",
      "Responsive Mobile-First Design",
      "SEO and Structured Data",
  ...
  },
  {
    ...
    screenshot: "/images/stores/ghanas-event-app-landing.jpeg",
    mobileScreenshots: [
      { src: "/images/stores/ghanas-event-app-landing.jpeg", label: "Landing" },
      { src: "/images/stores/ghanas-event-app-home.jpeg", label: "Home" },
      { src: "/images/stores/ghanas-event-app-menu.jpeg", label: "Profile menu" },
      { src: "/images/stores/ghanas-event-app-more.jpeg", label: "More" },
      { src: "/images/stores/ghanas-event-app-create-event.jpeg", label: "Create event" },
      { src: "/images/stores/ghanas-event-app-notifications.jpeg", label: "Notifications" },
      { src: "/images/stores/ghanas-event-app-settings.jpeg", label: "Settings" },
    ],
    link: "https://www.ghanasevent.com",
    siteStatus: "live",
    ...
    features: [
      ...
      "Mobile Money and Card Checkout",
      "Secure QR Code Tickets",
      "Ticket Wallet and History",
  ...
  },
  {
    ...
    client: "Ghanas Event",
    clientCountry: "Ghana",
    description: "The Ghanas Event Blog is a dedicated editorial platform for event organisers and attendees across Ghana. It publishes practical organiser guides, city event roundups, ticketing advice, platform updates, and stories from Ghana's growing live-events industry.",
    image: "/png/projects/ghanas-event-blog.png",
    desktopImage: "/portfolio/desktop/ghanas-event-blog.png",
  ...
  },
  {
    ...
    techLogos: [
      ...
      { name: "TypeScript",   logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" },
      { name: "Tailwind CSS", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" },
      { name: "Sanity CMS",   logo: "https://upload.wikimedia.org/wikipedia/commons/7/7e/Sanity-logo-svg.svg" },
      { name: "Spotify Widget", logo: "https://upload.wikimedia.org/wikipedia/commons/8/84/Spotify_icon.svg" },
      { name: "Patreon Widget", logo: "https://upload.wikimedia.org/wikipedia/commons/1/17/Digital-Patreon-Logo_Black.png" },
    ],
  ...
  {
    title: "Kafui Dey Books",
    slug: "kafui-dey-books",
    youtubeId: "",
    category: "e-commerce & retail",
    client: "Kafui Dey",
    clientCountry: "Ghana",
    description:
      "An online bookstore for Kafui Dey titles and related publications — browse books, learn about new releases, and order copies online. Project is in progress; images coming soon.",
    image: "/png/screenshots/placeholder.svg",
    desktopImage: "/png/screenshots/placeholder.svg",
  ...
  },
  {
    ...
    image: "/png/projects/doeman-all.webp",
    desktopImage: "/portfolio/desktop/doeman-desktop.webp",

...
async function sendServiceRequestEmails({
  ...
  const companyHtml = brandedEmail({
    ...
    fields,
    footerNote: 'Reply to the client using their preferred contact method. After review, share the project agreement if appropriate.',
  });

  const userHtml = brandedEmail({
    title: 'Service request received',
    intro: `Hi ${firstName}, thanks for requesting a service from Celestial Web Solutions. We have received your project brief and will follow up within 24 hours. You can also download your project agreement from the success screen on our site.`,
    fields: {
      Service: service,
      Company: company,
      Budget: budget || 'Not specified',

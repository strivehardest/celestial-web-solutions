...
async function sendServiceRequestEmails({
  ...
  const autoresponseText = [
    ...
    `Preferred contact: ${preferredContact || 'Email'}`,
    '',
    'Your Celestial project agreement PDF is attached to this email (and available on the success screen).',
    '',
    '— Celestial Web Solutions',
    'info@celestialwebsolutions.net | +233 24 567 1832',
    'www.celestialwebsolutions.net',
  ...
  // Generate the same project agreement PDF clients can download, and attach it to Celestial + visitor emails via Resend.
  ...
  return { ok: true, results, pdfAttached: Boolean(pdfAttachment) };
}

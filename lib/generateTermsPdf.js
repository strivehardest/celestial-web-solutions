...
function drawChrome(doc, fonts, meta, logoPath, pageNumber, pageCount) {
...
function generateTermsPdfBuffer() {
  ...
  return new Promise((resolve, reject) => {
    ...
    const fonts = registerPdfFonts(doc, { requireUnicode: true });
    ...
    for (let i = 0; i < range.count; i += 1) {
      ...
      drawChrome(doc, fonts, TERMS_META, logoPath, i + 1, range.count);
    }

...
${cta('View pricing', '/pricing')} ${cta('WhatsApp a brief', 'https://wa.me/233530505031')}`,
  ...
  },
  {
    ...
    weight: 2.2,
    answer: () =>
      `Yes — after you send a service request on the ${link('contact page', '/contact')} or via Talk to Expert, you can download a **Celestial client project agreement PDF** with your request details, estimated timeframe, payment terms, and signature lines.\n\nIt summarises the understanding between you and Celestial Web Solutions. A final quote may still refine fees and dates after discovery.\n\n${cta('Contact form', '/contact')} ${cta('WhatsApp us', 'https://wa.me/233530505031')} ${cta('View terms', '/terms', 'secondary')}`,
  },
  {
    id: 'refund',
    keywords: [

...
const AGREEMENT_BLOCK = '[[agreement]]';
...
${cta('View pricing', '/pricing')} ${cta('WhatsApp a brief', 'https://wa.me/233530505031')}`,
  ...
  },
  {
    ...
    weight: 2.2,
    answer: () =>
      `Yes — you can download a **Celestial client project agreement PDF** with your request details, estimated timeframe, payment terms, and signature lines.\n\nIt summarises the understanding between you and Celestial Web Solutions after a service request. A final quote may still refine fees and dates after discovery.\n\nUse the form below, or submit via the ${link('contact page', '/contact')} / Talk to Expert modal (the download appears after a successful send).\n\n${AGREEMENT_BLOCK}\n\n${cta('Contact form', '/contact')} ${cta('WhatsApp us', 'https://wa.me/233530505031')} ${cta('View terms', '/terms', 'secondary')}`,
  },
  {
    id: 'refund',
    keywords: [

  ...
  details: [
    ...
    },
    {
      ...
      content: [
        ...
        { name: "Google Tag Manager", url: "https://cocosolution.com/cms/uploads/o_1ebo7h0gt11ee3i7j764evn52a.jpg" }
      ]
    },
    {
      heading: "Pricing",
...
export default function GoogleAdsManagementServicePage() {
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
        ...
        <section className="relative min-h-[60vh] flex items-end overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-32">
            ...
            >
              <Link 
                href="/best-web-design-company-in-ghana" 

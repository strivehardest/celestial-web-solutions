        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          ...
          <div className="mt-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="tel:+233245671832" className="flex items-center justify-center text-white bg-orange-500 hover:bg-orange-600 font-bold py-2 px-4 rounded-xl transition-all text-sm" style={{ fontFamily: 'Albert Sans, sans-serif' }}>Call</a>
              <a href="https://wa.me/233530505031" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-white bg-green-500 hover:bg-green-600 font-bold py-2 px-4 rounded-xl transition-all text-sm" style={{ fontFamily: 'Albert Sans, sans-serif' }}>WhatsApp</a>

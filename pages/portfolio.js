      ...
      <Link href={`/portfolio/${project.slug}`} className="group block">
        ...
        >
          ...
          {project.completionDate === "In Progress" && (
            <div
              className="absolute top-3 left-3 z-20 px-2.5 py-1 bg-yellow-500 text-white text-[10px] font-bold rounded-full flex items-center gap-1 shadow-md"
              style={{ fontFamily: "Albert Sans, sans-serif" }}
            >
      ...
      : projects.filter((p) => {
          ...
          switch (filter) {
            ...
            case "educational institutions":
              return (
                title.includes("school") || description.includes("educational")
              );
            case "healthcare & wellness":
              return (
                title.includes("health") || description.includes("healthcare")
              );
            case "restaurants & hospitality":
              return (
                title.includes("restaurant") || description.includes("food")
              );
            default:
              return (
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore our portfolio of successful web development projects. See how we've helped businesses, NGOs, churches, educational institutions and more grow with custom websites, e-commerce solutions, and digital platforms."
        />
        <meta
          name="keywords"
          content="best web designer in accra and ghana, web development portfolio, website projects, e-commerce websites, Ghana web projects, Celestial Web Solutions work, NGO websites, church websites, educational websites, best web designer in accra"
        />
        <link
          rel="canonical"
          href="https://www.celestialwebsolutions.net/portfolio"
        />
      </Head>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 py-32">
            ...
            >
              ...
              <p
                ...
                style={{ fontFamily: "Albert Sans, sans-serif" }}
              >
                From sleek corporate websites to powerful e-commerce platforms —
                explore how we've helped businesses across Ghana, the U.S., and
                beyond establish a powerful online presence.
              </p>
        ...
        {/* ── Review Badges ─────────────────────────────────────────────────── */}
        <section className="relative z-20 w-full bg-gray-900 py-6 px-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/10 rounded-2xl overflow-hidden border border-white/15 backdrop-blur-md shadow-xl shadow-black/20">
              ...
              >
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  ...
                  <span
                    className="text-white/50 text-[10px] tracking-wide"
                    style={{ fontFamily: "Albert Sans, sans-serif" }}
                  >
                    Trustpilot
                  </span>
          ...
          >
            ...
            <div className="relative z-10 text-center px-4">
              ...
              <p
                ...
                style={{ fontFamily: "Albert Sans, sans-serif" }}
              >
                Let's create something amazing together. Whether it's a website,
                e-commerce platform, or custom web application, we're here to
              ...
              <div
                className="mt-12 flex flex-wrap justify-center gap-8 text-orange-100 text-sm"
                style={{ fontFamily: "Albert Sans, sans-serif" }}
              >
                {["Free Consultation", "24/7 Support", "Fast Delivery"].map(
                  (item) => (

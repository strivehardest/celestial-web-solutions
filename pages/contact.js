    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <section className="relative py-20 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-orange-500/95" />
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-orange-100 dark:border-gray-700">
                  <div className="px-6 py-5 bg-orange-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border border-blue-100 dark:border-gray-700">
                  <div className="px-6 py-5 bg-blue-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-orange-400 rounded-full opacity-5 transform translate-x-16 -translate-y-16" />

    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/courses">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-lg" style={{ fontFamily: '"Albert Sans", sans-serif', fontWeight: 600 }}>
              Back to Courses
            </button>
          </Link>
        </div>
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 mb-8 text-left">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700 dark:text-gray-300" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/courses">
              <button className="px-8 py-4 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl font-semibold hover:bg-gray-300 dark:hover:bg-gray-600 transition-all duration-300" style={{ fontFamily: '"Albert Sans", sans-serif', fontWeight: 600 }}>
                Browse More Courses
              </button>
            </Link>
            <Link href="/">
              <button className="px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300" style={{ fontFamily: '"Albert Sans", sans-serif', fontWeight: 600 }}>
                Back to Home
              </button>
            </Link>
          </div>
        ...
        <section className="relative min-h-[60vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 w-full text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                {course.subtitle}
              </p>
              ...
              <div className="flex items-center justify-center gap-6 text-white">
                <div className="flex items-center gap-2">
                  ...
                  <span style={{ fontFamily: '"Albert Sans", sans-serif' }}>1 Year Access</span>
                </div>
                <div className="flex items-center gap-2">
                  <Award className="w-5 h-5 text-yellow-500" />
                  <span style={{ fontFamily: '"Albert Sans", sans-serif' }}>Certificate</span>
                </div>
                <div className="flex items-center gap-2">
                  <Shield className="w-5 h-5 text-blue-500" />
                  <span style={{ fontFamily: '"Albert Sans", sans-serif' }}>Secure Payment</span>
                </div>
              </div>
            </motion.div>
          </div>
...
<h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2" style={{ fontFamily: '"Bricolage Grotesque", sans-serif', fontWeight: 700 }}>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent placeholder:font-albert"
                          style={{ fontFamily: '"Albert Sans", sans-serif' }}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              onChange={handleChange}
                              required
                              className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent placeholder:font-albert"
                              style={{ fontFamily: '"Albert Sans", sans-serif' }}
                    ...
                    <div className="bg-orange-500 border border-orange-600 rounded-xl p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-white/90 mb-3" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                          ...
                          <div className="flex flex-wrap gap-2">
                            <span className="inline-flex items-center gap-1 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full text-xs font-semibold text-white" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                  ...
                  <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-gray-700 dark:text-gray-300" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                        I agree to the{' '}
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-orange-500 hover:bg-orange-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed" style={{ fontFamily: '"Albert Sans", sans-serif', fontWeight: 700 }}
                  >
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                ...
                <div className="space-y-3 mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex justify-between text-gray-700 dark:text-gray-300" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                    <span>Original Price</span>
                    <span style={{ fontFamily: '"Bricolage Grotesque", sans-serif', fontWeight: 600 }}>{course.currency} {course.originalPrice}</span>
                  </div>
                  {course.discount > 0 && (
                    <div className="flex justify-between text-green-600 dark:text-green-400 font-semibold" style={{ fontFamily: '"Albert Sans", sans-serif' }}>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4">
                  ...
                  <ul className="space-y-2">
                    {course.includes.slice(0, 4).map((item, index) => (
                      <li key={index} className="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300" style={{ fontFamily: '"Albert Sans", sans-serif' }}>

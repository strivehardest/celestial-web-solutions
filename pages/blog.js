...
export const blogArticles = [
  ...
  },
  {
    ...
    excerpt: "Looking for the best web design company in Ghana? We ranked and reviewed the top 12 agencies based on portfolio quality, client reviews, SEO expertise, and industry recognition.",
    category: "Web Design",
    author: "Celestial Team",
    date: "March 3, 2026",
    ...
    hashtags: ["#WebDesignGhana", "#BestWebDesignCompany", "#GhanaTech", "#CelestialWebSolutions"]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    hashtags: ["#WebDesignGhana", "#ChooseWebDesigner", "#GhanaDigital", "#TechGuide"]
  },
  {
    id: 15,
    ...
    readTime: "5 min read",
    image: "https://images.unsplash.com/photo-1658297063569-162817482fb6?q=80&w=1074&auto=format&fit=crop",
    alt: "How to start an online store in Ghana - Celestial Web Solutions Ghana",
    featured: true,
    tags: ["E-commerce", "Ghana", "Online Business", "Startup"],
    hashtags: ["#EcommerceGhana", "#GhanaBusiness", "#OnlineStore", "#StartupTips"]
  },
  {
    id: 16,
    ...
    hashtags: ["#WordPressGhana", "#CustomWebsite", "#WebDevelopment", "#GhanaBusiness"]
  },
  {
    id: 17,
    ...
    featured: true,
    tags: ["UI/UX Design", "User Experience", "Web Design", "Ghana"],
    hashtags: ["#UIUXDesign", "#WebDesignGhana", "#UserExperience", "#GhanaWeb"]
  },
  {
    id: 1001,
    ...
    readTime: "4 min read",
    image: "https://images.unsplash.com/photo-1635405050330-b0824eb1bf26?q=80&w=1169&auto=format&fit=crop",
    ...
    hashtags: ["#WebDesign2026", "#GhanaBusiness", "#DigitalTrends"]
  },
  {
    id: 1002,
    ...
    date: "December 29, 2025",
    readTime: "4 min read",
    image: "https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=764&auto=format&fit=crop",
    alt: "Building a future-ready website for Ghanaian and international markets in 2026",
    featured: true,
    tags: ["future-ready", "global", "Ghana", "website", "2026"],
    hashtags: ["#FutureReady", "#GhanaWeb", "#InternationalBusiness"]
  },
  {
    id: 1,
    ...
    hashtags: ["#WebDesignGhana", "#AccraWebDesigners", "#GhanaDigital"]
  },
  {
    id: 13,
    ...
    hashtags: ["#DigitalMarketingGhana", "#ContentMarketing", "#GhanaBusiness"]
  },
  {
    id: 6,
    ...
    hashtags: ["#WebDevelopment", "#ReactJS", "#NextJS", "#JavaScript"]
  },
  {
    id: 2,
    ...
    hashtags: ["#WebDesignPricing", "#GhanaPrices", "#WebsiteCost"]
  },
  {
    id: 3,
    ...
    hashtags: ["#GhanaBusiness", "#DigitalTransformation", "#WebsiteGhana"]
  },
  {
    id: 4,
    ...
    hashtags: ["#SEOGhana", "#LocalSEO", "#GoogleRanking"]
  },
  {
    id: 7,
    ...
    hashtags: ["#MobileMoney", "#PaymentGhana", "#MTNMoMo"]
  },
  {
    id: 8,
    ...
    hashtags: ["#ResponsiveDesign", "#MobileFirst", "#WebDesign"]
  },
  {
    id: 9,
    ...
    hashtags: ["#ChatGPT", "#AIinTech", "#WebDevelopment"]
  },
  {
    id: 10,
    ...
    hashtags: ["#CyberSecurity", "#WebsiteSecurity", "#GhanaTech"]
  },
  {
    id: 11,
    ...
    hashtags: ["#EcommerceGhana", "#OnlineShopping", "#DigitalRetail"]
  },
  {
    id: 12,
    ...
    hashtags: ["#GoogleAds", "#SEO", "#DigitalMarketing"]
  },
  {
    id: 18,
    ...
    hashtags: ["#WebDesignGhana", "#GhanaWebAgencies", "#DigitalMarketingGhana"]
  },
  {
    id: 19,
    ...
    hashtags: ["#DigitalMarketingGhana", "#SEOGhana", "#SocialMediaGhana"]
  },
];

// ─── Page Component ────────────────────────────────────────────────────────────
export default function BlogPage({ sanityPosts = [] }) {
  ...
  // Convert Sanity posts to match static article shape
  const sanityArticles = useMemo(() => sanityPosts.map(post => ({
    id: post._id,
    slug: post.slug?.current,
    title: post.title,
    excerpt: post.excerpt || '',
    category: post.category || 'Web Design',
    author: post.author || 'Celestial Team',
  ...
  // Merge: Sanity posts first, then static (skip slug duplicates)
  const allArticles = useMemo(() => {
    const existingSlugs = new Set(blogArticles.map(a => a.slug));
    const newSanityArticles = sanityArticles.filter(a => a.slug && !existingSlugs.has(a.slug));
    return [...newSanityArticles, ...blogArticles];
  }, [sanityArticles]);

  // Sync search from URL (hashtag links)
  useEffect(() => {
  ...
  const categories = useMemo(() =>
    ["All", ...new Set(allArticles.map(a => a.category))],
  [allArticles]);
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-32 md:pt-40 pb-16 md:pb-24">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-orange-500/10 text-orange-400 border border-orange-500/20 mb-6" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                  Our Blog
                </span>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight" style={{ fontFamily: "Bricolage Grotesque, sans-serif" }}>
                  The Celestial Blog
                </h1>
                <p className="mt-4 text-lg md:text-xl text-gray-400 max-w-xl" style={{ fontFamily: "Albert Sans, sans-serif" }}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="relative max-w-sm w-full">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none transition-all"
                ...
                >
                  <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800">
                    <img
                      ...
                      alt={heroArticle.alt || heroArticle.title}
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      {heroArticle.source === 'sanity' && (
                        <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                          New
                        </span>
                      )}
                    ...
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors leading-tight" style={{ fontFamily: "Bricolage Grotesque, sans-serif" }}>
                      {heroArticle.title}
                    </h2>
                    <p className="mt-4 text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed line-clamp-3" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                      {heroArticle.excerpt}
                    </p>
                    <div className="mt-6 flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                      <span className="flex items-center gap-1.5"><User className="w-4 h-4" />{heroArticle.author}</span>
                      <span className="flex items-center gap-1.5"><Clock className="w-4 h-4" />{heroArticle.readTime}</span>
                    </div>
                  </div>
                </motion.div>
              </Link>
                    ...
                    <Link href={`/blog/${article.slug}`} className="group block">
                      <article className="grid md:grid-cols-[1fr_280px] gap-6 md:gap-8 py-8 border-b border-gray-100 dark:border-gray-800 items-center">
                        <div className="order-2 md:order-1">
                          ...
                          <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors leading-snug" style={{ fontFamily: "Bricolage Grotesque, sans-serif" }}>
                            {article.title}
                          </h3>
                          <p className="mt-2.5 text-gray-500 dark:text-gray-400 text-sm md:text-base leading-relaxed line-clamp-2" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                            {article.excerpt}
                          </p>
        ...
        <section className="border-t border-gray-100 dark:border-gray-800">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white" style={{ fontFamily: "Bricolage Grotesque, sans-serif" }}>
                Ready to build something great?
              </h2>
              <p className="mt-3 text-gray-500 dark:text-gray-400 text-base" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                Let&rsquo;s create a fast, beautiful website that grows your business. Get a free consultation today.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/contact" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold transition-colors" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                  Get Started <ArrowRight className="w-4 h-4" />
                </Link>
                <Link href="/web-design-company-in-ghana" className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-semibold hover:border-gray-400 dark:hover:border-gray-500 transition-colors" style={{ fontFamily: "Albert Sans, sans-serif" }}>
                  View Services
                </Link>
              </div>
            </div>
